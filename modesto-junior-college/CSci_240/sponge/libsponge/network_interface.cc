//
// Author: August Frisk
// Course: CS240 - Fall 2017
// Assign: Lab 05
// File: network_interfaces.cc
//
// Description: Implementation of a network interface. Translates from
//              { IP datagram, next hop address } to link-layer frame, and
//              from link-layer frame to IP datagram.
//
