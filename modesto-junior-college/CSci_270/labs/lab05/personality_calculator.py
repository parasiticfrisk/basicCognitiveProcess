...
# Assignment: Lab 05
# Filename: personality_caluclator.py
# Version: 1.0.1
#
...
#              user.  If the input is invalid, the program displays an error
#              message.
#
...
if accumulator == 1:
    print("Hi {}!".format(username) + paragraph_1)
elif accumulator == 2:
    print("Hi {}!".format(username) + paragraph_2)
elif accumulator == 3:
    print("Hi {}!".format(username) + paragraph_3)
elif accumulator == 4:
    print("Hi {}!".format(username) + paragraph_4)
elif accumulator == 5:
    print("Hi {}!".format(username) + paragraph_5)
elif accumulator == 6:
    print("Hi {}!".format(username) + paragraph_6)
elif accumulator == 7:
    print("Hi {}!".format(username) + paragraph_7)
elif accumulator == 8:
    print("Hi {}!".format(username) + paragraph_8)
elif accumulator == 9:
    print("Hi {}!".format(username) + paragraph_9)
else:
    print("Something went wrong...")  # accumulator >= 10 will be out of range!


if accumulator >= 1 and accumulator <= 9:
